...
conf.bands <- function(surv.object, conf.type='plain', type='ep', tL=NA, tU=NA){
  #load("~/Google Drive/PH 1831 Survival Analysis/Homeworks/CI_95_EP_and_HW_confidence_coefficient.RData")
  load("C:/Users/cwebb01/Downloads/CI_95_EP_and_HW_confidence_coefficient.RData")
  s <- surv.object
  fit <- survfit(s ~ 1)
  n <- length(s)/2
...
Using the function above, the equal probability (EP) bands are found by calling the function conf.bands.
