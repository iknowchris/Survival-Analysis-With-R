...
# Replicating the Results in This Book

This book uses the following R packages. Bolded packages are not part of standard R distributions and need to be installed if you are planning on using their functions.
